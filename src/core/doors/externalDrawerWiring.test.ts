...
// Cabinet-wide door width tests live in
// `src/core/geometry/frontGeometry.test.ts`. The per-box helpers
// (`getDoorWidth`, `getPartitionDoorWidth`) were removed in the unified
// cabinet-level layout refactor — partitions no longer affect front widths
// (fronts are an overlay, see CARPENTRY_RULES).
