...
const he: Translations = {
  ...
  project: {
    ...
    kitchenModules: { drawers: 'מגירות', shelves: 'מדפים', sink: 'כיור', dishwasher: 'מדיח', oven: 'תנור' },
...
const en: Translations = {
  ...
  project: {
    ...
    kitchenModules: { drawers: 'Drawers', shelves: 'Shelves', sink: 'Sink', dishwasher: 'Dishwasher', oven: 'Oven' },
