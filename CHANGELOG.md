...
### נוסף — מנוע מגירות Blum TANDEM (ליבה, שלבים 1–2)
...
- 27 בדיקות חדשות (`drawerBox.test.ts`, `drawerDrilling.test.ts`) — כולל הדוגמה המחושבת-ביד (גוף 60×60, חזית 310 → תיבה 557×540, דפנות 270, חזית/גב 247). תשתית לשלבים הבאים: לשונית "מגירות" בהגדרות + בורר חומרה בהוספת מגירה לגוף.
