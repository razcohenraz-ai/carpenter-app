...
- תאים נפרדים בעורך גוף עם מחיצה — כל תא (ימני/שמאלי) מקבל פריטים פנימיים עצמאיים במידות מותאמות לרוחב התא
...
- עורך תאים עם מחיצה: כל תא מציג כעת סקיצת SVG (BoxBodySketch) עם הפריטים שלו ואפשרות גרירה — תוקן Bug 1 (תצוגה ריקה במצב מחיצה)
- CabinetSketch ו-BoxThumbnail מציגים כעת פריטים פנימיים של תאים בגוף עם מחיצה, כולל קו מחיצה אנכי — תוקן Bug 2 (תאים לא הוצגו בסקיצה הראשית)
